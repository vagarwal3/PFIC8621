...
describe('Form8621Calculator no tax liability', () => {
    it('Compute is returning incorrect value', () => {
        ...
        transactions.push(new Transaction('Ref1', 'Sample Fund1', TransactionType.Purchase, new Date(2021, 0, 1), 100, 100));
        transactions.push(new Transaction('Ref2', 'Sample Fund2', TransactionType.Purchase, new Date(2022, 0, 1), 200, 200));
        transactions.push(new Transaction('Ref3', 'Sample Fund3', TransactionType.Purchase, new Date(2020, 0, 1), 300, 300));
        transactions.push(new Transaction('Ref3', 'Sample Fund3', TransactionType.Dispose, new Date(2021, 0, 1), 150, 150));
...
describe('Form8621Calculator no profit', () => {
    it('Compute is returning incorrect value', () => {
        ...
        transactions.push(new Transaction('Ref1', 'Sample Fund1', TransactionType.Purchase, new Date(2021, 0, 1), 100, 100));
        transactions.push(new Transaction('Ref1', 'Sample Fund1', TransactionType.Dispose, new Date(2022, 3, 1), 100, 100));
        transactions.push(new Transaction('Ref2', 'Sample Fund2', TransactionType.Purchase, new Date(2022, 1, 21), 100, 100));
        transactions.push(new Transaction('Ref2', 'Sample Fund2', TransactionType.Dispose, new Date(2022, 7, 10), 100, 100));
        ...
        let expectedResult = [
            {
                ...
                Form8621:{ReferenceIDNumber:"Ref1",FundName: "Sample Fund1"}
            },
            {
                ReferenceIDNumber: "Ref2",
                FundName: "Sample Fund2",
                Form8621:{ReferenceIDNumber:"Ref2",FundName: "Sample Fund2"}
            }
        ];
