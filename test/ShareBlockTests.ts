...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2022, 0, 1), 100, new Date(2022, 0, 1), 100);
        
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 0);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2022, 0, 1), 100, new Date(2022, 0, 1), 101);

        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1);
        assert.equal(shareBlock.ShareBlockYearDetails.length, 1);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2022, 0, 1), 78.9, new Date(2022, 0, 1), 200.78);

        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 121.88);
        assert.equal(shareBlock.ShareBlockYearDetails.length, 1);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2022, 0, 1), 1000, new Date(2022, 0, 2), 2000);

        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1000);
        assert.equal(shareBlock.ShareBlockYearDetails.length, 1);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2022, 2, 14), 1000, new Date(2022, 6, 23), 2000);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2021, 2, 14), 1000, new Date(2022, 6, 12), 2000);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1000);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2019, 11, 10), 1024.21, new Date(2022, 10, 30), 2056.90);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1032.69);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2018, 7, 14), 1034, new Date(2022, 11, 1), 3056.80);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 2022.80);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2017, 5, 11), 1704.78, new Date(2022, 4, 12), 4456.89);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 2752.11);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2016, 4, 10), 1014.71, new Date(2022, 10, 20), 2206.50);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1191.79);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, true, null, 1, new Date(2015, 4, 10), 1004.78, new Date(2022, 7, 1), 9056.43);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 8051.65);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, false, 2022, 1, new Date(2020, 4, 10), 1014.10, new Date(2022, 6, 26), 2056.90);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1042.80);
        assert.equal(shareBlock.ShareBlockYearDetails.length, 3);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, false, 2021, 1, new Date(2020, 4, 10), 1014.10, new Date(2022, 6, 26), 2056.90);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1042.80);
        assert.equal(shareBlock.ShareBlockYearDetails.length, 3);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, false, 2020, 1, new Date(2020, 4, 10), 1014.10, new Date(2022, 6, 26), 2056.90);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1042.80);
        assert.equal(shareBlock.ShareBlockYearDetails.length, 3);
        assert.equal(shareBlock.Line16B, 267.15);
...
describe('ShareBlock', () => {
    it('ShareBlock initialization is correct', () => {
        let shareBlock: ShareBlock = new ShareBlock(2022, false, 2019, 1, new Date(2020, 4, 10), 1014.10, new Date(2022, 6, 26), 2056.90);
        assert.equal(shareBlock.NumberOfUnits, 1);
        assert.equal(shareBlock.Profit, 1042.80);
        assert.equal(shareBlock.ShareBlockYearDetails.length, 3);
        assert.equal(shareBlock.Line16B, 267.15);
